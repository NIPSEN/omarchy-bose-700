...
// bose-700-deploy: puts files into, and removes named files from, directories
...
//
// Usage:
//   bose-700-deploy put [--unless-git-checkout] <dir> <mode> <file>...
//   bose-700-deploy remove [--rmdir] <dir> <name>...
//
...
[[noreturn]] void die(const std::string& message) {
    std::cerr << "bose-700-deploy: " << message << "\n";
    std::exit(1);
}
...
int main(int argc, char** argv) {
    ...
    if (args.empty()) die("usage: bose-700-deploy put|remove ...");
